...
<head>
  ...
  <style>
    ...
    width: auto;
    height: auto;
    /* Combines brightness and a soft white glow */
    filter: brightness(150%) drop-shadow(0 0 10px rgba(255, 255, 255, 0.5));
    transition: filter 0.3s ease;
    }

    .logo-glow:hover {
        /* Makes the glow more intense when hovered */
        filter: brightness(200%) drop-shadow(0 0 15px rgba(255, 255, 255, 0.8));
    }
    ...
    .navmenu ul li a { color: rgba(255,255,255,0.85) !important; }
    .navmenu ul li a:hover,
    .navmenu ul li a.active { color: #10b981 !important; }
    ...
    .icon-box {
      width: 80px;
      height: 80px;
      background: rgba(0, 184, 148, 0.1); /* Warna accent dengan opacity rendah */
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          ...
          <h2 class="mb-2">Lupa Kata Laluan?</h2>
          <p class="small mb-4" style="color: #bdc3c7;">Masukkan e-mel anda dan kami akan hantar arahan untuk menetap semula kata laluan anda.</p>
            ...
            <div class="text-center mb-4">
              <button type="button" id="sendLinkBtn" class="btn-login">Hantar</button>
            </div>
  ...
  function validateAndSend() {
    ...
    if (!valid) {
      ...
      .catch(error => {
        sendBtn.innerHTML = 'Hantar';
        sendBtn.disabled = false;
        emailError.innerText = "Berlaku ralat sistem. Sila cuba lagi.";
        emailError.style.display = "block";
