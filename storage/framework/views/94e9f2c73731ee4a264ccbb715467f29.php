      ...
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="stat-card text-center">
            ...
            <p class="stat-value"><?php echo e($totalOrders ?? 0); ?></p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="stat-card text-center">
            ...
            <p class="stat-value"><?php echo e($pendingApprovals ?? 0); ?></p>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="stat-card text-center">
            ...
            <p class="stat-value"><?php echo e($inProgressOrders ?? 0); ?></p>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="stat-card text-center">
            ...
            <p class="stat-value"><?php echo e($pendingPenerimaan ?? 0); ?></p>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="stat-card text-center">
            ...
            <p class="stat-value"><?php echo e($completedOrders ?? 0); ?></p>
          </div>
        </div>
      </div>
