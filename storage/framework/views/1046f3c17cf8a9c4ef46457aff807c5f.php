      ...
      <div class="card-box section-card mb-4">
        ...
        <div class="row g-4">
          <div class="col-md-4">
            ...
            <input class="form-control" id="noPesanan" type="text" value="<?php echo e(old('no_pesanan', $inden->no_pesanan ?? '')); ?>" placeholder="Akan dijana automatik" readonly>
          </div>
          <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-4">
            ...
            <input class="form-control <?php $__errorArgs = ['sesi_kod'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="sesi_kod" type="text" value="<?php echo e(old('sesi_kod', $inden->sesi_kod ?? '')); ?>" placeholder="e.g. M1/M2/M3/M4" <?php echo e($fieldState); ?> required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-6">
            ...
            <input type="hidden" name="institution_id" value="<?php echo e(old('institution_id', $inden->institution_id ?? $userInstitutionId)); ?>" id="institutionIdHidden">
      ...
      <div class="row g-4">
        <div class="col-12">
          <div class="card-box section-card h-100">
            ...
            <div class="row g-4">
              <div class="col-md-6"><label class="form-label">Disediakan Oleh</label><input class="form-control" type="text" value="<?php echo e(old('disediakan_oleh', $inden->disediakan_oleh ?? Auth::user()->name ?? '')); ?>" placeholder="Nama pegawai yang diberi kuasa memesan" readonly></div>
              <div class="col-md-6"><label class="form-label">Jawatan / Cop</label><input class="form-control" type="text" value="<?php echo e(old('jawatan_cop', $inden->jawatan_cop ?? ($userPositionName ? $userPositionName . ' Gred ' . $userGrade : ''))); ?>" readonly></div>
              <div class="col-md-6">
                <label class="form-label">Nama Wakil Pembekal <span class="text-danger">*</span></label>
                <input class="form-control" name="wakil_pembekal" type="text" value="<?php echo e(old('wakil_pembekal', $inden->wakil_pembekal ?? $inden->nama_pembekal ?? '')); ?>" placeholder="Akan diisi automatik" readonly>
              </div>
              <div class="col-md-6">
