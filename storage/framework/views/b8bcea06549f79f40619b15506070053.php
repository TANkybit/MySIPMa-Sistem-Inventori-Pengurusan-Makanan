<?php
    ...
    $pageTitles = [
        ...
        'stok-kritikal' => 'Item Stok Kritikal',
    ...
    $pageRoutes = [
        ...
        'stok-kritikal' => 'pengarah.negeri.stok_kritikal',
...
<body>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <nav class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('pengarah.negeri.stok_kritikal') ? 'active' : ''); ?>" href="<?php echo e(route('pengarah.negeri.stok_kritikal', $institutionQuery)); ?>">
                ...
                <div class="container-fluid py-4">
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3 text-end">
                                            <a href="<?php echo e(route('pengarah.negeri.stok_kritikal', $institutionQuery)); ?>" class="btn btn-sm btn-outline-warning"><i class="fas fa-eye me-1"></i>Lihat Semua</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php elseif($activePage === 'stok-kritikal'): ?>
                        <?php
                            ...
                            $totalCriticalCount = collect($lowStockItems)->count();
                            $outOfStockCount = collect($lowStockItems)->filter(function($i) {
                                $item = (array)$i;
                                return ($item['stock'] ?? 0) <= 0;
                            })->count();
                            $criticalStageCount = collect($lowStockItems)->filter(function($i) {
                                $item = (array)$i;
                                return ($item['stock'] ?? 0) > 0 && ($item['stockPercentage'] ?? 0) <= 50;
                            })->count();
                            $warningStageCount = collect($lowStockItems)->filter(function($i) {
                                $item = (array)$i;
                                return ($item['stockPercentage'] ?? 0) > 50;
                            })->count();
                        ?>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body p-4 d-flex align-items-center justify-content-between">
                                        <div>
                                            <div class="text-uppercase small fw-bold text-muted mb-1">Tahap Sangat Kritikal</div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body p-4 d-flex align-items-center justify-content-between">
                                        <div>
                                            <div class="text-uppercase small fw-bold text-muted mb-1">Tahap Amaran</div>
                            ...
                            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <h5 class="card-title fw-bold mb-0 text-body">
                                        <i class="fas fa-boxes-packing text-warning me-2"></i>Senarai Keseluruhan Item Stok Kritikal
                                    </h5>
                                    <p class="text-muted small mb-0">Memaparkan semua bahan mentah yang berada di tahap amaran atau di bawah minimum stok</p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="critical-stock-all-table" class="table table-bordered table-hover align-middle w-100">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $lowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <?php
                                                    $itemArr = (array)$item;
                                                    ...
                                                    $statusLabel = $itemArr['statusLabel'] ?? ($stock <= 0 ? 'Habis Stok' : ($percentage <= 50 ? 'Kritikal' : 'Amaran'));
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="progress flex-grow-1" style="height: 10px;">
                                                                <div class="progress-bar <?php echo e($progressClass); ?> progress-bar-striped progress-bar-animated" role="progressbar" style="width: <?php echo e(min(100, max(5, $percentage))); ?>%" aria-valuenow="<?php echo e($percentage); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <tr>
                                                    <td colspan="7" class="text-center py-4 text-muted">Tiada item stok kritikal.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card border-0 shadow-sm mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3 bg-light p-2 rounded">
                                            ...
                                            <select id="negeriTrendInstitusi" class="form-select form-select-sm" style="width: 250px;">
                                                <option value="">Semua Institusi</option>
                                                <?php $__currentLoopData = $institutions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($inst->id); ?>"><?php echo e($inst->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <select id="negeriTrendPembekal" class="form-select form-select-sm" style="width: 250px;">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-lg-7">
                                                ...
                                                <div id="negeriPerformanceTrendChart" style="min-height: 300px;"></div>
                                            </div>
                                            <div class="col-lg-5">
                                                <h6 class="fw-bold mb-3"><i class="fas fa-chart-pie me-2 text-success"></i>Taburan Rating Prestasi</h6>
                                                <div id="negeriPerformanceRatingChart" style="min-height: 300px;"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border-0 shadow-sm mb-4">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <select class="form-select form-select-sm" id="negeriMonthlyInstitusiFilter" style="width: 200px;">
                                                <option value="">Semua Institusi</option>
                                                <?php $__currentLoopData = $institutions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($inst->id); ?>"><?php echo e($inst->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <select class="form-select form-select-sm" id="negeriMonthlyPembekalFilter" style="width: 200px;">
                                                <option value="">Semua Pembekal</option>
                                            </select>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3 align-items-end g-2">
                                            <div class="col-auto">
                                                ...
                                                <select id="negeriFilterEvalYear" class="form-select form-select-sm" style="width: 110px;">
                                                    <option value="">Semua</option>
                                                    <?php for($y = date('Y'); $y >= date('Y') - 5; $y--): ?>
                                                        <option value="<?php echo e($y); ?>"><?php echo e($y); ?></option>
                                                    <?php endfor; ?>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <select id="negeriFilterEvalInstitusi" class="form-select form-select-sm" style="min-width: 180px;">
                                                    <option value="">Semua Institusi</option>
                                                    <?php $__currentLoopData = $institutions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($inst->id); ?>"><?php echo e($inst->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <select id="negeriFilterEvalPembekal" class="form-select form-select-sm" style="min-width: 180px;">
                                                    <option value="">Semua Pembekal</option>
                                                </select>
                                            </div>
                                            <div class="col-auto">
                                                <button class="btn btn-sm btn-outline-secondary" id="negeriBtnClearEvalFilter">
    ...
    <script>
        ...
        // ====== NEGERI CHARTS STATE ======
        let negeriTrendChart = null;
        let negeriRatingChart = null;
        window._negeriEvalStore = [];
        window._negeriEvalUnfiltered = [];

        // ====== STATS & CHARTS ======
        function negeriUpdateStatCards(evalList) {
            ...
            document.getElementById('negeriStatTotalEval').textContent = total;
            document.getElementById('negeriStatAvgPercentage').textContent = avg + '%';
            document.getElementById('negeriStatCemerlangCount').textContent = cemerlang;
            document.getElementById('negeriStatLemahCount').textContent = lemah;
            return { total, avg, cemerlang, sederhana, lemah };
        }

        function negeriRenderTrendChart(evalList) {
            const trendEl = document.getElementById('negeriPerformanceTrendChart');
            if (!trendEl) return;
            if (negeriTrendChart) { negeriTrendChart.destroy(); negeriTrendChart = null; }
            ...
            negeriTrendChart = new ApexCharts(trendEl, {
            ...
            negeriTrendChart.render();
        }

        function negeriRenderRatingChart(evalList) {
            const ratingEl = document.getElementById('negeriPerformanceRatingChart');
            if (!ratingEl) return;
            if (negeriRatingChart) { negeriRatingChart.destroy(); negeriRatingChart = null; }
            ...
            negeriRatingChart = new ApexCharts(ratingEl, {
            ...
            negeriRatingChart.render();
        }

        function negeriRefreshChartsAndStats(evalList) {
            negeriUpdateStatCards(evalList);
            negeriRenderTrendChart(evalList);
            negeriRenderRatingChart(evalList);
        }

        // ====== POPULATE SUPPLIER DROPDOWNS ======
        function negeriPopulateSupplierDropdowns(evalList) {
            const suppliers = {};
            evalList.forEach(ev => {
            ...
            ['negeriTrendPembekal', 'negeriMonthlyPembekalFilter', 'negeriFilterEvalPembekal'].forEach(id => {
        ...
        // ====== TREND FILTER (INSTITUSI + PEMBEKAL) ======
        function negeriApplyTrendFilter() {
            const instId = document.getElementById('negeriTrendInstitusi')?.value || '';
            const suppId = document.getElementById('negeriTrendPembekal')?.value || '';
            let filtered = window._negeriEvalUnfiltered;
            if (instId) filtered = filtered.filter(ev => String(ev.institution_id) === instId);
            if (suppId) filtered = filtered.filter(ev => String(ev.supplier_id) === suppId);
            negeriRefreshChartsAndStats(filtered);
        }
        ...
        async function loadNegeriMonthlyStats(year) {
            ...
            const instId = document.getElementById('negeriMonthlyInstitusiFilter')?.value || '';
            const suppId = document.getElementById('negeriMonthlyPembekalFilter')?.value || '';

            let url = `/evaluations/monthly?year=${year}`;
        ...
        // ====== EVALUATIONS TABLE + CLIENT-SIDE FILTER ======
        function renderNegeriEvaluationsTable(dataList) {
            ...
            dataList.forEach(ev => {
                ...
                html += `<tr>
                    ...
                    <td class="text-center fw-bold">${parseFloat(ev.percentage).toFixed(1)}%</td>
            ...
            tableBody.innerHTML = html;
            if ($.fn.DataTable.isDataTable('#negeri-evaluations-table')) { $('#negeri-evaluations-table').DataTable().destroy(); }
            setTimeout(() => { $('#negeri-evaluations-table').DataTable({ responsive: true, order: [[0, 'desc']], language: { emptyTable: 'Tiada rekod ditemui.', zeroRecords: 'Tiada rekod yang sepadan.' } }); }, 100);
        }

        function negeriApplyEvalFilter() {
            const yearVal = document.getElementById('negeriFilterEvalYear')?.value || '';
            const instVal = document.getElementById('negeriFilterEvalInstitusi')?.value || '';
            const suppVal = document.getElementById('negeriFilterEvalPembekal')?.value || '';
            let filtered = window._negeriEvalUnfiltered;
            if (yearVal) filtered = filtered.filter(ev => new Date(ev.evaluation_date).getFullYear() === parseInt(yearVal));
            if (instVal) filtered = filtered.filter(ev => String(ev.institution_id) === instVal);
            if (suppVal) filtered = filtered.filter(ev => String(ev.supplier_id) === suppVal);
            window._negeriEvalStore = filtered;
            renderNegeriEvaluationsTable(filtered);
        }
        ...
        async function loadNegeriEvaluationsHistory() {
            try {
                ...
                if (json.success && json.data.length > 0) {
                    ...
                    window._negeriEvalUnfiltered = json.data;
                } else {
                    window._negeriEvalStore = [];
                    window._negeriEvalUnfiltered = [];
                }
            ...
            negeriPopulateSupplierDropdowns(window._negeriEvalUnfiltered);
            renderNegeriEvaluationsTable(window._negeriEvalStore);
            negeriRefreshChartsAndStats(window._negeriEvalUnfiltered);
        }
        <?php endif; ?>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Monthly table institution & supplier filters
            const negeriMonthlyInstFilter = document.getElementById('negeriMonthlyInstitusiFilter');
            const negeriMonthlySuppFilter = document.getElementById('negeriMonthlyPembekalFilter');
            if (negeriMonthlyInstFilter) {
                negeriMonthlyInstFilter.addEventListener('change', function() {
                    loadNegeriMonthlyStats(negeriYearSelect?.value || new Date().getFullYear());
                });
            }
            if (negeriMonthlySuppFilter) {
                negeriMonthlySuppFilter.addEventListener('change', function() {
                    loadNegeriMonthlyStats(negeriYearSelect?.value || new Date().getFullYear());
                });
            }

            // Trend chart filters (institusi + pembekal)
            const negeriTrendInstFilter = document.getElementById('negeriTrendInstitusi');
            const negeriTrendSuppFilter = document.getElementById('negeriTrendPembekal');
            if (negeriTrendInstFilter) negeriTrendInstFilter.addEventListener('change', negeriApplyTrendFilter);
            if (negeriTrendSuppFilter) negeriTrendSuppFilter.addEventListener('change', negeriApplyTrendFilter);

            // Evaluations table filters (tahun + institusi + pembekal)
            const negeriEvalYearFilter = document.getElementById('negeriFilterEvalYear');
            const negeriEvalInstFilter = document.getElementById('negeriFilterEvalInstitusi');
            const negeriEvalSuppFilter = document.getElementById('negeriFilterEvalPembekal');
            if (negeriEvalYearFilter) negeriEvalYearFilter.addEventListener('change', negeriApplyEvalFilter);
            if (negeriEvalInstFilter) negeriEvalInstFilter.addEventListener('change', negeriApplyEvalFilter);
            if (negeriEvalSuppFilter) negeriEvalSuppFilter.addEventListener('change', negeriApplyEvalFilter);

            // Clear eval filter button
            const negeriBtnClear = document.getElementById('negeriBtnClearEvalFilter');
            if (negeriBtnClear) {
                negeriBtnClear.addEventListener('click', function() {
                    if (negeriEvalYearFilter) negeriEvalYearFilter.value = '';
                    if (negeriEvalInstFilter) negeriEvalInstFilter.value = '';
                    if (negeriEvalSuppFilter) negeriEvalSuppFilter.value = '';
                    negeriApplyEvalFilter();
                });
            }
            ...
            document.addEventListener('click', function(e) {
                ...
                if (viewBtn) {
                    ...
                    const store = window._negeriEvalUnfiltered || window._negeriEvalStore || [];
                    const found = store.find(x => String(x.id) === String(id));
            ...
            if ($.fn.DataTable) {
                ...
                if (document.getElementById('inventory-table')) {
                    ...
                    $('#inventory-table').DataTable({
                        language: { emptyTable: 'Tiada data inventori untuk tempoh dipilih.' }
                    });
                }
    ...
    <script>
        $(document).ready(function() {
            if ($('#critical-stock-all-table').length && $.fn.dataTable) {
                $('#critical-stock-all-table').DataTable({
                    language: {
