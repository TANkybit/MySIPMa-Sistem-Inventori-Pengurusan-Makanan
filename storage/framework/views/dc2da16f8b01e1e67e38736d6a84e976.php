                            ...
                            <div class="card-footer bg-transparent border-0 pb-4">
                                <div class="row text-center mb-3">
                                    <div class="col-6 border-end">
                                        <h5 class="mb-0"><?php echo e(auth()->user()?->grade ?? 'N/A'); ?></h5>
                            ...
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li
                                        ...
                                        <span class="fw-medium"><?php echo e(auth()->user()?->username ?? 'pengarah_hq'); ?></span>
                                    </li>
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                        <span><i class="fas fa-building me-2 text-primary"></i>Institusi</span>
                                        <span
                                            class="fw-medium" id="displayProfileInstitution"><?php echo e(optional(($institutions ?? collect())->firstWhere('id', auth()->user()?->institution_id))->name ?? auth()->user()?->institution ?? 'Ibu Pejabat Penjara'); ?></span>
                                    </li>
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                value="<?php echo e(auth()->user()?->username); ?>" id="inputProfileUsername">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Gred</label>
                                            <input type="text" class="form-control" name="grade"
                                                value="<?php echo e(auth()->user()?->grade); ?>" id="inputProfileGrade">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-12">
...
<?php /**PATH C:\laragon\www\MySIPMA_2\resources\views\dashboard.blade.php ENDPATH**/ ?>