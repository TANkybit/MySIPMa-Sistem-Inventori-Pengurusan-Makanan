...
<body>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          ...
          <div class="card login-card text-center">
            <img src="<?php echo e(url('frontend/Nexa/assets/img/LOGOMYSIPMA.png')); ?>" class="login-logo mx-auto" alt="MySIPMa">
  ...
  <div class="text-end mb-4">
    <a href="<?php echo e(route('password.request')); ?>" class="small" style="color: #00d2ff;">Lupa Kata Laluan?</a>
  </div>
  ...
  <button type="button" id="loginBtn" class="btn-login">Log Masuk</button>
            ...
            <div class="footer-links mt-4">
              <a href="<?php echo e(route('index')); ?>">← Kembali ke Halaman Utama</a>
            </div>
          </div>
...
// Validation and Login Script
  ...
  <?php if(session('swal')): ?>
  <script>
    Swal.fire(<?php echo session('swal'); ?>);
  </script>
  <?php endif; ?>
</body>
</html>
<?php /**PATH C:\laragon\www\MySIPMA_2\resources\views/login.blade.php ENDPATH**/ ?>