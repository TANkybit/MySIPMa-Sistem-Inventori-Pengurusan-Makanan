                ...
                <div class="profile-display-layout">
                    ...
                    <div class="profile-display-left">
                        <div id="avatarDisplay" class="avatar-display">
                            <img src="<?php echo e($avatarUrl); ?>" alt="Avatar Image">
                        </div>
                    </div>
                    <!-- Info Display -->
                    <div class="profile-display-right">
                        <div class="info-item">
                            <label>Nama:</label>
                            <p id="displayNama"><?php echo e(Auth::user()->name); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Emel:</label>
                            <p id="displayEmail"><?php echo e(Auth::user()->email); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Institusi:</label>
                            <p id="displayInstitusi"><?php echo e($institutionName); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Jawatan:</label>
                            <p id="displayJawatan"><?php echo e($positionName); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Peranan:</label>
                            <p id="displayPeranan"><?php echo e($roleName); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Telefon:</label>
                            <p id="displayTelefon"><?php echo e(Auth::user()->phone_number ?? '-'); ?></p>
                        </div>
                        <div class="info-item">
                            <label>Alamat:</label>
                            <p id="displayAlamat"><?php echo e($fullAddress ?: '-'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\MySIPMa\resources\views/profile.blade.php ENDPATH**/ ?>