  ...
  <header id="header" class="header d-flex align-items-center sticky-top"
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <div class="d-none d-xl-flex align-items-center gap-3">
        ...
        <button type="button" class="btn btn-custom btn-logout btn-sm px-3 py-2 {{ in_array(strtoupper(Auth::user()->getPositionCode()), ['PS','PR','PP'], true) ? 'logout-icon-only' : '' }}" id="desktopLogoutBtn" title="Log Keluar" aria-label="Log Keluar"><i
