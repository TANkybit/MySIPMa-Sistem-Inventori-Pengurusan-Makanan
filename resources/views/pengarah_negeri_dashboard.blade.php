...
<head>
    ...
    <title>Pengarah Negeri Dashboard</title>
...
<body>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <nav class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('pengarah.negeri.dashboard') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pengarah.negeri.dashboard') }}">
                    ...
                    <div class="page-title">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Pengarah Negeri</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="container-fluid py-4">
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="GET" action="{{ route('pengarah.negeri.dashboard') }}" class="row g-3 align-items-end">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card p-4">
                                <h6 class="text-uppercase text-muted mb-3">Jumlah Item Dipesan</h6>
                                <h3 class="mb-0">{{ $inventoryItems->sum('total_ordered_quantity') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-lg-12">
                            ...
                            <div id="inventory-section" class="d-none">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Inventori Negeri</h5>
                                        <div class="table-responsive">
    ...
    <script>
        ...
        function setActiveTab(tabId) {
            ['tab-dashboard', 'tab-inventory'].forEach(id => {
        ...
        function showSection(sectionId) {
            ['dashboard-section', 'inventory-section'].forEach(id => {
